            ...
            <div class="container d-flex h-100 shadow-lg rounded-5 p-0">
                ...
                <aside class="col-xl-2 col-lg-3 col-md-4 py-4 d-flex flex-column position-relative">
                    ...
                    <div class="my-style-home-dashboard-aside">
                        ...
                        {{-- Elemento aside Navbar  --}}
                        <a href="{{ route('restaurants.edit', ['restaurant' => $restaurant]) }}" class="ms-4 text-decoration-none text-black underline-hover">
                            <div class="lh-1 my-1 fs-4 underline-hover d-flex">
                                <span class="me-3">
                                    <img width="25" height="25" src="https://img.icons8.com/ios/50/edit--v1.png" alt="edit--v1"/>
                                </span>
                                <span>
                                    Modifica Ristorante
                                </span>
